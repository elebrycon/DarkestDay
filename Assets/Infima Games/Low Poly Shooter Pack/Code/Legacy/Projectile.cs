...
namespace InfimaGames.LowPolyShooterPack.Legacy
{
	public class Projectile : MonoBehaviour
	{
        ...
        private void OnCollisionEnter(Collision collision)
		{
			...
			{
				collision.transform.gameObject.GetComponent<EnemyHealth>().TakeNormalDamage(gameObject.transform.position, playerPosition.forward, 10);

                GameObject.FindGameObjectWithTag("GameController").SendMessage("RootAlertNearby", playerPosition.position, SendMessageOptions.DontRequireReceiver);
                Debug.Log("Enemy Hit");
			}
